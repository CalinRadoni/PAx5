...
public:
	...
	bool SetModeAnalog(void);        ///< SetMode shortcut function
	bool SetModeDigitalOutput(void); ///< SetMode shortcut function
	bool SetModeDigitalInput(void);  ///< SetMode shortcut function
