...
Add this: https://help.github.com/articles/adding-an-existing-project-to-github-using-the-command-line/
...
Create a remote repository for the USB stick
...
Add a remote named @origin@ at the url of the new repository and push the local branch there
Example:
bc.
git remote add origin https://github.com/CalinRadoni/PAx5.git
